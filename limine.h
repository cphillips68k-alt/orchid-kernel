...
/* Forward declare terminal struct for callback typedef */
...
#define LIMINE_ENTRY_POINT_REQUEST { LIMINE_COMMON_MAGIC, 0x13d86c035a1cd3e1, 0x2a0bfa9755a7d465 }
...
#define LIMINE_RSDP_REQUEST { LIMINE_COMMON_MAGIC, 0xc5e77b6b397e7b43, 0x27637845accdcf3 }
...
#define LIMINE_REQUESTS_START_MARKER \
    uint64_t limine_requests_start_marker[4] = { 0xf6b8f4b39de7d1ae, 0xfab91a6940fcb9cf, \
                                                 0x785c6ed015d3e316, 0x181e920a5c44e15f };
#define LIMINE_REQUESTS_END_MARKER \
    uint64_t limine_requests_end_marker[4] = { 0xadc0e0531bb10d03, 0x9572709b5d6b4eb7, \
                                               0xc6edd1b93d7f00ed, 0x3c6a9ac7879b3180 };
...
struct limine_kernel_info {
    uint64_t magic;
    uint64_t revision;
    LIMINE_PTR(void *) requests_start;
    LIMINE_PTR(void *) requests_end;
};
